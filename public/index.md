...
[Acessar o bot](/bot-start)[Ver como funciona](#como-funciona)
Prefere pelo aplicativo? [Criar pelo App →](https://app.partidinha.com/)
...
@Partidinha Bot entrar

18:31

Partidinha BotBot

Pelada das Quintas FC (Sáb, 18:00)
Campo do Bairro Novo

Gabriel entrou! (14/14)

Você conhece essa cena?

## O grupo do Whats virou bagunça.
E você é o único que se estressa.
...
Pedrinho, Neco, Lucas e mais 11

Pedrinho
Vou mas só posso chegar 20h30

20:14

Neco
Foi mal, não vou conseguir ir hoje

20:17

Lucas
Galera quem pagou o Pix da quadra?? Ninguém mandou comprovante no pv

20:23

Gente CONFIRMA logo pfvr

20:31

- Mensagens perdidas no meio de memes e áudios longos
- Você vira o “chato do privado” tendo que cobrar dinheiro de amigo
- Sorteio no papel no dia do jogo perdendo tempo de quadra
...
Bot do Partidinha está online

Bot do Partidinha

Resenha FC (Ter, 01/09 20:00)
...
- Confirmação via comando simples (@partidinha entrar)
- Cobrança automática dos devedores do grupo sem constrangimento
- Sorteio equilibrado em 1 clique no app com stats históricas

Sua pelada vira um campeonato profissional!Bora pro campo

Tudo que seu time precisa

## Tudo que sua pelada precisa para rodar no piloto automático
...
No dia do jogo, sorteie os times, anote os gols no app e veja a resenha acontecer.
...
Renan adicionou **Bot do Partidinha**

Bot do Partidinhaoficial
Fala, craques! A partir de agora eu cuido das **confirmações**, do **sorteio dos times** e da **cobrança do Pix**.
...
Grupo conectado ao app do **Renan**. Pode criar a primeira partida!
...
[Começar grátis](https://app.partidinha.com/)

Recomendado

### Plano Pro

Para o admin que quer automação completa.
...
[Assinar Pro](https://app.partidinha.com/)
